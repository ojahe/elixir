defmodule HelloWeb.PostControllerTest do
  ...
  @create_attrs %{data_scope: "some data_scope", inserted_by: "some inserted_by", post_code: "some post_code", post_name: "some post_name", post_sort: 42, remark: "some remark", status: 42, updated_by: "some updated_by"}
  ...
  def fixture(:post) do
    {:ok, post} = Sys.create_post(@create_attrs)
    post
  end
  ...
  describe "update post" do
    ...
    test "redirects when data is valid", %{conn: conn, post: post} do
      ...
      assert html_response(conn, 200) =~ "some updated data_scope"
    end
