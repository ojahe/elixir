defmodule Hello.Sys.Post do
  ...
  def changeset(post, attrs) do
    ...
    |> validate_length(
         :data_scope,
         max: 255,
         message: "#{dgettext("sys_post", "Data scope")} #{gettext("max length is")} 255"
       )
    ...
    |> validate_length(
         :inserted_by,
         max: 255,
         message: "#{dgettext("sys_post", "Inserted by")} #{gettext("max length is")} 255"
       )
    ...
    |> validate_length(
         :post_code,
         max: 255,
         message: "#{dgettext("sys_post", "Post code")} #{gettext("max length is")} 255"
       )
    ...
    |> validate_length(
         :post_name,
         max: 255,
         message: "#{dgettext("sys_post", "Post name")} #{gettext("max length is")} 255"
       )
    ...
    |> validate_length(
         :updated_by,
         max: 255,
         message: "#{dgettext("sys_post", "Updated by")} #{gettext("max length is")} 255"
       )
